...
alter table jobs add column leader_id int;
ALTER TABLE jobs ADD FOREIGN KEY (leader_id) REFERENCES users (id)  ON DELETE SET NULL;
...
INSERT INTO status( name ) VALUES ("̃Đ̃a thực hiện");

insert into users(email,password,fullname,role_id) values('nguyenvana@gmail.com','123456','Nguyen Van A',1);
insert into users(email,password,fullname,role_id) values('tranvanc@gmail.com','123456','Tran Van C',2);
