            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="<c:url value="/task/add"></c:url>" method="post">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12">Tên công việc<span style="color: red">${tasknameExistedMsg}</span></label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select class="form-control form-control-line" name="users">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12">Trạng thái</label>
                                    <div class="col-md-12">
