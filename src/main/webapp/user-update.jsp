                        ...
                        <li>
                            <div class="dropdown">
                                <a class="profile-pic dropdown-toggle" data-toggle="dropdown" href="#"> 
                                    <img src="<c:url value="/plugins/images/users/varun.jpg"></c:url>" alt="user-img" width="36" class="img-circle" />
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="<c:url value="/blank.jsp"></c:url>" class="waves-effect"><i class="fa fa-columns fa-fw"
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Sửa thông tin nhân viên</h4>
                    </div>
                </div>
                <!-- /.row -->
                <!-- .row -->
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="<c:url value="/user/update?id=${id}"></c:url>" method="post">
                                <div class="form-group">
                                    <label class="col-md-12">Full Name<span style="color: red">${full_name}</span></label>
                                    <div class="col-md-12">
                                        <input type="text" name="fullname" placeholder="Johnathan Doe"
                                            class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <label for="example-email" class="col-md-12">Email<span style="color: red">${emailExistedMsg}</span></label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12">Current Password <span style="color: red">${currentPasswdMsg}</span> </label> 
                                    <div class="col-md-12">
                                        <input type="password" name="curentpassword" value="password" class="form-control form-control-line">
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <label class="col-md-12">New Password</label>
                                    <div class="col-md-12">
                                        <input type="password" name="newpassword" value="password" class="form-control form-control-line">
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <label class="col-md-12">Re-type New Password <span style="color: red">${retypePasswdMsg}</span> </label>
                                    <div class="col-md-12">
                                        <input type="password" name="retypenewpassword" value="password" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="avatar" placeholder="Enter your image URL" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button type="submit" class="btn btn-success">Update</button>
                                        <a href="<c:url value="/user"></c:url>" class="btn btn-primary">Return</a>
                                    </div>
                                </div>
                            </form>
                        </div>
