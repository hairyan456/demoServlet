                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href='<c:url value="/task"></c:url>' class="waves-effect"><i class="fa fa-table fa-fw"
                                aria-hidden="true"></i><span class="hide-menu">Công việc</span></a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href='<c:url value="/404.html"></c:url>' class="waves-effect"><i class="fa fa-info-circle fa-fw"
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="<c:url value="/project/update?project_id=${project_id}"></c:url>" method="post">
                                <div class="form-group">
                                    <label class="col-md-12">Tên dự án <span style="color: red">${projectname}</span></label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <c:forEach items="${listLeaders}" var="item" varStatus="loop">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        ...
                                        <a href='<c:url value="/project"></c:url>' class="btn btn-primary">Return</a>
                                    </div>
                                </div>
                            </form>
                        </div>
