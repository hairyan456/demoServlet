...
<body>
		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse slimscrollsidebar">
				<ul class="nav" id="side-menu">
					...
					<li><a href='<c:url value="/404.html"></c:url>' class="waves-effect"><i
			...
			<div class="container-fluid">
				<div class="row bg-title">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
						<a href='<c:url value="/project/add"></c:url>' class="btn btn-sm btn-success">Thêm
							mới</a>
					</div>
					<!-- /.col-lg-12 -->
				</div>
									...
									<tbody>
										<c:forEach items="${listProjects}" var="project"
											...
											<tr>
												...
												<td>${project.getLeaderName()}</td>
												<td><a href='<c:url value="/project/update?project_id=${project.id}"></c:url>' class="btn btn-sm btn-primary">Sửa</a>
													<a href="#" project-id="${project.id}" class="btn btn-sm btn-danger btn-delete-project">Xóa</a>
													<a href='<c:url value="/project/view?id=${project.id}"></c:url>' class="btn btn-sm btn-info">Xem</a>
												</td> 
											</tr>
										</c:forEach>
									</tbody>
	...
	<script src='<c:url value="/js/groupwork-table.js?version=1"></c:url>'></script>
	<script>
