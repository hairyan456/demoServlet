            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Chỉnh sửa quyền</h4>
                    </div>
                </div>
                <!-- /.row -->
                <!-- .row -->
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="<c:url value="/role/update?role_id=${role_id}"></c:url>" method="post">
                                <div class="form-group">
                                    <label class="col-md-12">Tên quyền<span style="color: red">${role_name}</span></label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12">Mô tả<span style="color: red">${descrip_tion}</span></label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        ...
                                        <a href='<c:url value="/role"></c:url>' class="btn btn-primary">Return</a>
                                    </div>
                                </div>
                            </form>
                        </div>
